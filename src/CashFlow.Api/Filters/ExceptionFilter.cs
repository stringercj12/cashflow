...
namespace CashFlow.Api.Filters
{
    public class ExceptionFilter : IExceptionFilter
    {
        ...
        private void HandleProjectException(ExceptionContext context)
        {
            ...
            if (context.Exception is ErrorOnValidationException erroprOnValidationException)
            {
                var errorResponse = new ResponseErrorJson(erroprOnValidationException.Errors);
